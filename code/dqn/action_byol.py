...
class BYOL(nn.Module):
    def __init__(
        ...
        DEFAULT_AUG = torch.nn.Sequential(
            ...
            T.Normalize(
                mean=torch.tensor([0.485, 0.456, 0.406, 0.423]),
                std=torch.tensor([0.229, 0.224, 0.225, 0.226])),
        )
        ...
        self.online_predictor = MLP(projection_size + action_shape, projection_size, projection_hidden_size)
